  ...
  public render = () => {
    ...
    return (
      <SLayout>
        ...
        <Section />
        <Footer />
        <RegisterModal show={this.state.showRegisterModal} networkId={networkId} address={address} balance={balance} killSession={this.resetApp} hideModal={this.hideRegisterModal}/>
      </SLayout>
    );
  };
}
